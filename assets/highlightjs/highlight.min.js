...
var hljs = (function () {
  ...
  const h = '[a-zA-Z]\\w*',
    ...
    w = (e, t, n = {}) => {
      ...
      return (
        s.contains.push(_),
        s.contains.push({ className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):', relevance: 0 }),
        s
      );
    },
    N = w('//', '$'),
  ...
  return ((e) => {
    ...
    function p(e, t, n, a) {
      ...
      function g(e) {
        return (
          e.className && k.openNode(_.classNameAliases[e.className] || e.className),
      ...
      try {
        ...
        if (o) return { illegal: !1, relevance: 0, value: I(i), emitter: k, language: e, top: y, errorRaised: t };
        throw t;
      }
    }
    function m(e, t) {
      ...
      const n = ((e) => {
          const t = { relevance: 0, emitter: new d.__emitter(d), value: I(e), illegal: !1, top: u };
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (t) => {
      ...
      return (
        (n.disableAutodetect = !1), (n.name = 'C++'), (n.aliases = ['cc', 'c++', 'h++', 'hpp', 'hh', 'hxx', 'cxx']), n
      );
    };
  })(),
);
    ...
    return (e) => {
      ...
      return {
        ...
        contains: [
          ...
          { begin: /\{/, end: /\}/, illegal: /\S/, contains: [e.C_BLOCK_COMMENT_MODE, { begin: /;/ }, a] },
        ],
      };
    };
  })(),
  ...
  (() => {
    ...
    return (t) => {
      const c = e,
        ...
        l = { $pattern: e, keyword: n.join(' '), literal: a.join(' '), built_in: s.join(' ') },
        b = '\\.([0-9](_?[0-9])*)',
        ...
        m = { className: 'string', begin: '`', end: '`', contains: [t.BACKSLASH_ESCAPE, E] },
        N = {
          className: 'comment',
          variants: [
            t.COMMENT('/\\*\\*', '\\*/', {
      ...
      const f = [].concat(N, E.contains),
        A = f.concat([{ begin: /\(/, end: /\)/, keywords: l, contains: ['self'].concat(f) }]),
        p = { className: 'params', begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: A };
      return {
        name: 'Javascript',
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (n) => {
      ...
      return (r.contains = c), (i.contains = c), { name: 'Perl', aliases: ['pl', 'pm'], keywords: s, contains: c };
    };
  })(),
);
hljs.registerLanguage(
      ...
      const n = {
        ...
        r = {
          ...
          variants: [
            ...
            { begin: /([fF][rR]|[rR][fF]|[fF])"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, a, i, s] },
      ...
      return (
        (s.contains = [r, b, a]),
        {
          ...
          contains: [
            ...
            { className: 'meta', begin: /^[\t ]*@/, end: /(?=#)|$/, contains: [b, o, r] },
            { begin: /\b(print|exec)\(/ },
          ],
        }
      );
        ...
        b = ((r) => {
          const c = e,
            ...
            E = {
              ...
              starts: { end: '`', returnEnd: !1, contains: [r.BACKSLASH_ESCAPE, u], subLanguage: 'xml' },
            },
            m = {
              begin: 'css`',
              end: '',
              starts: { end: '`', returnEnd: !1, contains: [r.BACKSLASH_ESCAPE, u], subLanguage: 'css' },
            },
            _ = { className: 'string', begin: '`', end: '`', contains: [r.BACKSLASH_ESCAPE, u] },
            y = {
              className: 'comment',
              variants: [
                r.COMMENT('/\\*\\*', '\\*/', {
